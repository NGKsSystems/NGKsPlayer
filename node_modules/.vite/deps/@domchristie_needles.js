...
// node_modules/@domchristie/needles/dist/needles.js
...
var ScriptProcessorAdapter = class {
  ...
  input(audioBuffer) {
    ...
    if (this.offline) {
      this.workerAdapter.message({
        type: "set",
        key: "duration",
        value: audioBuffer.duration * 1e3
      });
    }
...
//# sourceMappingURL=@domchristie_needles.js.map
