...
export class WorkletLoader {
  static async loadProfessionalAudioProcessor(audioContext) {
    try {
      // Try to load the worklet module - use absolute path for Vite
      const workletPath = '/src/ProAudioClipper/audio/worklets/ProfessionalAudioProcessorWorklet.js';
