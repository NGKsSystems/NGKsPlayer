  ...
  */
  ...
  const handlePointerDown = useCallback((e) => {
    ...
    const isInteractiveElement = e.target.closest('.vertical-slider-wrapper') || 
                                 ...
                                 e.target.closest('.knob') ||
                                 e.target.closest('.knob-btn') ||
                                 e.target.closest('.knob-controls-static') ||
                                 e.target.closest('.knob-display') ||
                                 e.target.closest('.adjustment-button') ||
                                 e.target.closest('.fx-param-slider') ||
                                 e.target.tagName === 'INPUT' ||
                                 e.target.tagName === 'BUTTON' ||
                                 e.target.closest('button') ||
                                 e.target.closest('.fx-type-btn');
    ...
    // Don't drag if clicking on controls or resize handles (except volume widgets and headerless widgets)
    if (!isVolumeWidget && !hideHeader && e.target.closest('.mixer-sub-widget') && !e.target.closest('.widget-header')) {
      return;
    }
