    ...
    <div className="mixer-container">
      <div className="mixer-workspace" style={{ position: 'relative', width: '100%', height: '600px' }}>
        ...
        <DraggableWidget
          ...
          width={mixerLayout['gain-a']?.width ?? 68}
          height={mixerLayout['gain-a']?.height ?? 104}
          className="mixer-sub-widget"
          minSize={{ width: 60, height: 96 }}
        ...
        <DraggableWidget
          ...
          width={mixerLayout['gain-b']?.width ?? 68}
          height={mixerLayout['gain-b']?.height ?? 104}
          className="mixer-sub-widget"
          minSize={{ width: 60, height: 96 }}
          hideHeader={true}
        ...
        {deckMode === '4deck' && (
          <DraggableWidget
            ...
            width={mixerLayout['gain-c']?.width ?? 68}
            height={mixerLayout['gain-c']?.height ?? 104}
            className="mixer-sub-widget"
            minSize={{ width: 60, height: 96 }}
            hideHeader={true}
        ...
        {deckMode === '4deck' && (
          <DraggableWidget
            ...
            width={mixerLayout['gain-d']?.width ?? 68}
            height={mixerLayout['gain-d']?.height ?? 104}
            className="mixer-sub-widget"
            minSize={{ width: 60, height: 96 }}
            hideHeader={true}
        ...
        <DraggableWidget
          ...
          width={mixerLayout['pitch-a']?.width ?? 68}
          height={mixerLayout['pitch-a']?.height ?? 104}
          className="mixer-sub-widget"
          minSize={{ width: 60, height: 96 }}
          hideHeader={true}
        ...
        <DraggableWidget
          ...
          width={mixerLayout['pitch-b']?.width ?? 68}
          height={mixerLayout['pitch-b']?.height ?? 104}
          className="mixer-sub-widget"
          minSize={{ width: 60, height: 96 }}
          hideHeader={true}
        ...
        {deckMode === '4deck' && (
          <DraggableWidget
            ...
            width={mixerLayout['pitch-c']?.width ?? 68}
            height={mixerLayout['pitch-c']?.height ?? 104}
            className="mixer-sub-widget"
            minSize={{ width: 60, height: 96 }}
            hideHeader={true}
        ...
        {deckMode === '4deck' && (
          <DraggableWidget
            ...
            width={mixerLayout['pitch-d']?.width ?? 68}
            height={mixerLayout['pitch-d']?.height ?? 104}
            className="mixer-sub-widget"
            minSize={{ width: 60, height: 96 }}
            hideHeader={true}
        ...
        >
          <div className="main-crossfader-container">
            <div className="main-crossfader-label">CROSSFADER</div>
            <div className="main-crossfader-wrapper">
              ...
              <input
                ...
                className="main-crossfader-slider"
              />
        ...
        <DraggableWidget
          ...
          width={mixerLayout['filter-a']?.width ?? 68}
          height={mixerLayout['filter-a']?.height ?? 104}
          className="mixer-sub-widget"
          minSize={{ width: 60, height: 96 }}
          hideHeader={true}
        ...
        <DraggableWidget
          ...
          width={mixerLayout['filter-b']?.width ?? 68}
          height={mixerLayout['filter-b']?.height ?? 104}
          className="mixer-sub-widget"
          minSize={{ width: 60, height: 96 }}
          hideHeader={true}
        ...
        {deckMode === '4deck' && (
          <DraggableWidget
            ...
            width={mixerLayout['filter-c']?.width ?? 68}
            height={mixerLayout['filter-c']?.height ?? 104}
            className="mixer-sub-widget"
            minSize={{ width: 60, height: 96 }}
            hideHeader={true}
        ...
        {deckMode === '4deck' && (
          <DraggableWidget
            ...
            width={mixerLayout['filter-d']?.width ?? 68}
            height={mixerLayout['filter-d']?.height ?? 104}
            className="mixer-sub-widget"
            minSize={{ width: 60, height: 96 }}
            hideHeader={true}
        ...
        <DraggableWidget
          ...
          width={mixerLayout['reverb-a']?.width ?? 68}
          height={mixerLayout['reverb-a']?.height ?? 104}
          className="mixer-sub-widget"
          minSize={{ width: 60, height: 96 }}
          hideHeader={true}
        ...
        <DraggableWidget
          ...
          width={mixerLayout['reverb-b']?.width ?? 68}
          height={mixerLayout['reverb-b']?.height ?? 104}
          className="mixer-sub-widget"
          minSize={{ width: 60, height: 96 }}
          hideHeader={true}
        ...
        {deckMode === '4deck' && (
          <DraggableWidget
            ...
            width={mixerLayout['reverb-c']?.width ?? 68}
            height={mixerLayout['reverb-c']?.height ?? 104}
            className="mixer-sub-widget"
            minSize={{ width: 60, height: 96 }}
            hideHeader={true}
        ...
        {deckMode === '4deck' && (
          <DraggableWidget
            ...
            width={mixerLayout['reverb-d']?.width ?? 68}
            height={mixerLayout['reverb-d']?.height ?? 104}
            className="mixer-sub-widget"
            minSize={{ width: 60, height: 96 }}
            hideHeader={true}
        ...
        >
          <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
            <div style={{ color: '#ffffff', fontSize: '11px', fontWeight: 'bold', textAlign: 'center', marginBottom: '8px', letterSpacing: '1px' }}>RECORDING</div>
        ...
        >
          <div className="microphone-controls">
            <div className="mic-header-label">MICROPHONE HQ</div>
