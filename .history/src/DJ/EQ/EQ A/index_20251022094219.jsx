...
const EQA = ({ id, audioContext, gainNode, pannerNode, style = {}, ...props }) => {
  ...
  return (
    <div 
      ref={widgetRef}
      className={`eq-a-widget ${isDragging ? 'dragging' : ''}`} 
      style={currentStyle} 
    ...
    >
      ...
      {/* Resize Handle */}
      {/* Removed: resize handles for standalone draggable component */}
    </div>
  );
};
