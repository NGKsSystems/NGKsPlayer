        ...
        <div style={{
          ...
          {samples.map((sample, index) => (
            <div 
              key={sample.id} 
              style={{
                background: (playingId === sample.id || playingId === `cue-${sample.id}`)
                ...
                minHeight: '80px',
                textAlign: 'center',
                boxShadow: (playingId === sample.id || playingId === `cue-${sample.id}`) 
            ...
            >
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{ 
                  ...
                  {/* We'll need to add duration calculation here - for now showing placeholder */}
                  Duration: --:--
                </div>
              </div>

              {/* Control Buttons - Positioned inside at bottom */}
              <div style={{ 
                display: 'flex', 
                gap: '2px',
                marginTop: '4px',
