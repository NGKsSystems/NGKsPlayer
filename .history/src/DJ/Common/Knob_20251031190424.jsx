...
const Knob = ({ 
  ...
  // Get label based on control type
  const getLabel = () => {
    if (controlType === 'gain') return 'GAIN';
    if (controlType === 'pitch') return 'PITCH';
    if (controlType === 'filter') return 'FILTER';
    if (controlType === 'reverb') return 'REVERB';
    return label || '';
  };
