...
const VerticalSlider = ({ 
  ...
  const updateValue = (e) => {
    ...
    // Apply to AudioManager using setVolume method
    if (audioManager && channel) {
      const deck = channel === 'A' ? 1 : 2;
      audioManager.setVolume?.(deck, clampedValue / 100);
      console.log(`Set deck ${deck} volume to ${clampedValue / 100}`);
    }
  };
