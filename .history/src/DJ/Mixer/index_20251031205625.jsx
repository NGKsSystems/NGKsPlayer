    ...
    <div className="mixer-container">
      <div className="mixer-workspace" style={{ position: 'relative', width: '100%', height: '600px' }}>
        ...
        <DraggableWidget
          ...
          width={mixerLayout['volume-a']?.width ?? 112}
          height={mixerLayout['volume-a']?.height ?? 144}
        ...
        <DraggableWidget
          ...
          width={mixerLayout['volume-b']?.width ?? 112}
          height={mixerLayout['volume-b']?.height ?? 144}
          className="mixer-sub-widget"
          minSize={{ width: 75, height: 120 }}
          hideHeader={true}
        ...
        >
          <Knob
            ...
            label="Volume"
          />
        </DraggableWidget>audioManager}
            channel="B"
          />
        </DraggableWidget>

        {/* Volume C - Knob - Only in 4-deck mode */}
        {deckMode === '4deck' && (
          <DraggableWidget
            id="volume-c"
            title="VOL C"
            ...
            width={mixerLayout['volume-c']?.width ?? 112}
            height={mixerLayout['volume-c']?.height ?? 144}
            className="mixer-sub-widget"
            minSize={{ width: 75, height: 120 }}
            hideHeader={true}
          ...
          >
            <Knob
              ...
              label="Volume"
            />
        {/* Volume D - Knob - Only in 4-deck mode */}
        {deckMode === '4deck' && (
          <DraggableWidget
            id="volume-d"
            title="VOL D"
            ...
            width={mixerLayout['volume-d']?.width ?? 112}
            height={mixerLayout['volume-d']?.height ?? 144}
            className="mixer-sub-widget"
            minSize={{ width: 75, height: 120 }}
            hideHeader={true}
        ...
        <DraggableWidget
          ...
          width={mixerLayout['master-volume']?.width ?? 112}
          height={mixerLayout['master-volume']?.height ?? 144}
          className="mixer-sub-widget"
          minSize={{ width: 75, height: 120 }}
          hideHeader={true}
        ...
        <DraggableWidget
          ...
          width={mixerLayout['cue-mix']?.width ?? 112}
          height={mixerLayout['cue-mix']?.height ?? 144}
          className="mixer-sub-widget"
          minSize={{ width: 75, height: 120 }}
          hideHeader={true}
        ...
        <DraggableWidget
          ...
          width={mixerLayout['headphone-volume']?.width ?? 112}
          height={mixerLayout['headphone-volume']?.height ?? 144}
          className="mixer-sub-widget"
          minSize={{ width: 75, height: 120 }}
          hideHeader={true}
