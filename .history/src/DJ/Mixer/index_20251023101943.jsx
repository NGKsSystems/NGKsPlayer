    ...
    <div className="mixer-container">
      ...
      <div className="mixer-workspace" style={{ position: 'relative', width: '100%', height: '600px' }}>
        ...
        <DraggableWidget
          ...
          onUpdate={(updates) => onMixerLayoutChange({ 'recording': updates })}
        >
        ...
        <DraggableWidget
          id="microphone"
          title="MIC"
          x={mixerLayout['microphone']?.x ?? 820}
          y={mixerLayout['microphone']?.y ?? 170}
          width={mixerLayout['microphone']?.width ?? 140}
          height={mixerLayout['microphone']?.height ?? 200}
          className="mixer-sub-widget"
          minSize={{ width: 130, height: 190 }}
          onUpdate={(updates) => onMixerLayoutChange({ 'microphone': updates })}
        >
          <div className="microphone-controls">
            ...
            <div className="mic-toggle">
              <label>
                <input
                  type="checkbox"
                  checked={mixerState.microphone.enabled}
                  onChange={(e) => handleMicrophoneChange('enabled', e.target.checked)}
                />
                <span className="toggle-label">{mixerState.microphone.enabled ? 'ON' : 'OFF'}</span>
              </label>
            </div>
            ...
            <div className="mic-control-section">
              ...
              <input
                ...
                onChange={(e) => handleMicrophoneChange('volume', parseInt(e.target.value))}
                className="mic-slider"
                disabled={!mixerState.microphone.enabled}
              />
              <span className="control-value">{mixerState.microphone.volume}%</span>
            </div>
            ...
            <div className="mic-control-section">
              ...
              <input
                ...
                onChange={(e) => handleMicrophoneChange('gain', parseInt(e.target.value))}
                className="mic-slider"
                disabled={!mixerState.microphone.enabled}
              />
              <span className="control-value">{(((mixerState.microphone.gain / 100) * 12) - 12).toFixed(1)}dB</span>
            </div>
            ...
            <div className="mic-control-section">
              ...
              <input
                ...
                onChange={(e) => handleMicrophoneChange('reverb', parseInt(e.target.value))}
                className="mic-slider"
                disabled={!mixerState.microphone.enabled}
              />
              <span className="control-value">{mixerState.microphone.reverb}%</span>
            </div>
          </div>
        </DraggableWidget>
      </div>
