...
const EffectsSend = ({ 
  ...
  const toggleEffect = () => {
    ...
    if (fxEngine && channel) {
      const chainId = `deck_${channel}`;
      fxEngine.setChainEnabled(chainId, newEnabled);
      console.log(`🎛️ FX on Deck ${channel} ${newEnabled ? 'ENABLED' : 'DISABLED'}`);
    }
