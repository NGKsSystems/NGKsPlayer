...
const Mixer = ({ audioManager, mixerLayout = {}, onMixerLayoutChange = () => {}, ...props }) => {
  ...
  const KNOB_WIDGET_IDS = ['gain-a', 'gain-b', 'fx-unit-a', 'fx-unit-b', 'fx-unit-c', 'fx-unit-d', 'master-fx', 'pitch-a', 'pitch-b', 'filter-a', 'filter-b'];
    ...
    <div className="mixer-container">
      <div className="mixer-workspace" style={{ position: 'relative', width: '100%', height: '600px' }}>
        ...
        <DraggableWidget
          ...
          width={mixerLayout['master-fx']?.width ?? 380}
