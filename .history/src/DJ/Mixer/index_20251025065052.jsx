  ...
  return (
    <div className="mixer-container">
      <div className="mixer-workspace" style={{ position: 'relative', width: '100%', height: '600px' }}>
        ...
        {/* Microphone Volume - Vertical Slider */}
        <DraggableWidget
          id="mic-volume"
          title="MIC VOL"
          x={mixerLayout['mic-volume']?.x ?? 980}
          y={mixerLayout['mic-volume']?.y ?? 20}
          width={mixerLayout['mic-volume']?.width ?? 80}
          height={mixerLayout['mic-volume']?.height ?? 150}
          className="mixer-sub-widget"
          minSize={{ width: 70, height: 130 }}
          onUpdate={(updates) => handleMixerSubwidgetUpdate({ 'mic-volume': updates })}
        >
          <VerticalSlider
        ...
        <DraggableWidget
          id="mic-toggle"
          title="MIC"
          x={mixerLayout['mic-toggle']?.x ?? 1080}
          y={mixerLayout['mic-toggle']?.y ?? 20}
          width={mixerLayout['mic-toggle']?.width ?? 80}
          height={mixerLayout['mic-toggle']?.height ?? 80}
          className="mixer-sub-widget"
          minSize={{ width: 70, height: 70 }}
          onUpdate={(updates) => handleMixerSubwidgetUpdate({ 'mic-toggle': updates })}
        >
        ...
        <DraggableWidget
          id="mic-gain"
          title="MIC GAIN"
          x={mixerLayout['mic-gain']?.x ?? 980}
          y={mixerLayout['mic-gain']?.y ?? 200}
          width={mixerLayout['mic-gain']?.width ?? 85}
          height={mixerLayout['mic-gain']?.height ?? 130}
          className="mixer-sub-widget"
          minSize={{ width: 75, height: 120 }}
          onUpdate={(updates) => handleMixerSubwidgetUpdate({ 'mic-gain': updates })}
        >
          <Knob
            id="mic-gain-knob"
        ...
        {/* Microphone Reverb - Knob */}
        <DraggableWidget
          id="mic-reverb"
          title="MIC REVERB"
          x={mixerLayout['mic-reverb']?.x ?? 1080}
          y={mixerLayout['mic-reverb']?.y ?? 200}
          width={mixerLayout['mic-reverb']?.width ?? 85}
          height={mixerLayout['mic-reverb']?.height ?? 130}
          className="mixer-sub-widget"
          minSize={{ width: 75, height: 120 }}
          onUpdate={(updates) => handleMixerSubwidgetUpdate({ 'mic-reverb': updates })}
        >
          <Knob
            id="mic-reverb-knob"
