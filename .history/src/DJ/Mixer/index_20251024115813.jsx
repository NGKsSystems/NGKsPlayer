    ...
    <div className="mixer-container">
      ...
      <div className="mixer-workspace" style={{ position: 'relative', width: '100%', height: '600px' }}>
        ...
        <DraggableWidget
          ...
          width={mixerLayout['crossfader']?.width ?? 400}
          height={mixerLayout['crossfader']?.height ?? 120}
          className="mixer-sub-widget"
        ...
        >
          <div className="microphone-controls">
            {/* Left Column: Toggle + Volume */}
            <div className="mic-left-column">
              {/* Mic On/Off Switch */}
            ...
            {/* Right Column: Knobs Side by Side */}
            <div className="mic-knobs-container">
              {/* Mic Gain Knob */}
              <Knob
                id="mic-gain"
                label="GAIN"
                ...
                min={0}
                max={100}
                onChange={(val) => handleMicrophoneChange('gain', val)}
              ...
              <Knob
                ...
                min={0}
                max={100}
                onChange={(val) => handleMicrophoneChange('reverb', val)}
                audioManager={props.audioManager}
                channel="MIC"
                controlType="reverb"
              />
