        ...
        {showSettings && (
          <div className="settings-panel">
            ...
            <div className="connection-diagram">
              <strong>🔌 Complete Wiring Setup:</strong>
              <div className="wiring-flow">
                <div className="wire-step">
                  <div className="wire-icon">💻</div>
                  <div className="wire-label">Your Laptop<br/>(Running this app)</div>
                </div>
                ...
                <div className="wire-step highlight">
                  <div className="wire-icon">📦</div>
                  <div className="wire-label">DMX Interface<br/><strong>THIS BOX!</strong></div>
                </div>
                <div className="wire-arrow">➜<br/><span className="cable-type">DMX Cables (XLR)<br/>Daisy-chain</span></div>
                <div className="wire-step">
                  <div className="wire-icon">💡💡💡</div>
                  <div className="wire-label">All Your Lights<br/>(Plug into interface)</div>
                </div>
              </div>
              <div style={{ marginTop: '12px', fontSize: '10px', textAlign: 'center', color: '#ffaa00', fontWeight: 'bold' }}>
                ⚡ Plus: Each light needs separate power cable to wall outlet!
              </div>
            </div>

            <div className="hardware-guide">
              <strong>📦 DMX Interface Options (This is the main box you need!):</strong>
              <ul>
                <li><strong>Budget:</strong> Enttec Open DMX USB ($65) - 1 universe, 512 channels</li>
                <li><strong>Mid-Range:</strong> DMXKing ultraDMX Micro ($89) - Reliable, compact</li>
                <li><strong>Professional:</strong> Enttec DMX USB Pro Mk2 ($299) - 2 universes</li>
                <li><strong>Wireless:</strong> DMXKing eDMX1 Pro ($349) - Art-Net over WiFi/Ethernet</li>
              </ul>
              
              <strong style={{ marginTop: '12px', display: 'block' }}>🔗 Complete Shopping List:</strong>
              <ol style={{ margin: '8px 0', paddingLeft: '20px', fontSize: '10px', lineHeight: 1.6 }}>
                <li><strong>DMX Interface</strong> - The main box ($65-$300) <span style={{ color: '#ff6600' }}>← START HERE</span></li>
                <li><strong>DMX Cables</strong> - 3-pin or 5-pin XLR ($10-25 each) - Need one per light</li>
                <li><strong>DMX Lights</strong> - Moving heads, PARs, wash lights, etc. (Any DMX fixtures)</li>
                <li><strong>Power Cables</strong> - Usually included with lights</li>
              </ol>

              <p style={{ marginTop: '8px', fontSize: '10px', color: 'rgba(255,255,255,0.8)', background: 'rgba(255,100,0,0.1)', padding: '8px', borderRadius: '4px', borderLeft: '3px solid #ff6600' }}>
                <strong>✓ YES:</strong> All lights plug into the DMX interface via DMX cables (daisy-chained)<br/>
                <strong>✓ YES:</strong> Each light also needs its own power cable to wall outlet<br/>
                <strong>✓ YES:</strong> The interface connects to your laptop via USB (that's the circled cable in the pic)
              </p>
            </div>
          </div>
        )}
