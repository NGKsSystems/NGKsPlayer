          ...
          <div className="settings-panel">
            ...
            <div className="connection-diagram">
              ...
              <div className="wiring-flow">
                ...
                <div className="wire-arrow">➜<br/><span className="cable-type">USB Cable</span></div>
                <div className="wire-step highlight">
                  <div className="wire-icon">📦</div>
                  <div className="wire-label">DMX Interface<br/>(Circled in your pic)</div>
                </div>
                <div className="wire-arrow">➜<br/><span className="cable-type">DMX Cables (XLR)</span></div>
                <div className="wire-step">
                  <div className="wire-icon">💡</div>
                  <div className="wire-label">Your Lights<br/>(Daisy-chained)</div>
                </div>
                <div className="wire-arrow">+<br/><span className="cable-type">Power Cables</span></div>
                <div className="wire-step">
                  <div className="wire-icon">⚡</div>
                  <div className="wire-label">Wall Outlet<br/>(Each light needs power!)</div>
                </div>
              </div>
            </div>

            <div className="hardware-guide">
              <strong>📡 Recommended DMX Interfaces:</strong>
              <ul>
                <li><strong>Budget:</strong> Enttec Open DMX USB ($65)</li>
                <li><strong>Mid-Range:</strong> DMXKing ultraDMX Micro ($89)</li>
                <li><strong>Professional:</strong> Enttec DMX USB Pro Mk2 ($299)</li>
                <li><strong>Wireless:</strong> DMXKing eDMX1 Pro Art-Net ($349)</li>
              </ul>
              
              <strong style={{ marginTop: '12px', display: 'block' }}>🔗 What You Need:</strong>
              <ol style={{ margin: '8px 0', paddingLeft: '20px', fontSize: '10px', lineHeight: 1.6 }}>
                <li><strong>DMX Interface</strong> - Box that converts USB to DMX (circled cable in your pic)</li>
                <li><strong>DMX Cables</strong> - 3-pin or 5-pin XLR cables (mic cables work!)</li>
                <li><strong>Power Cables</strong> - Standard power cords for each light fixture</li>
                <li><strong>Lights</strong> - Any DMX-compatible fixtures (moving heads, PARs, wash, etc.)</li>
              </ol>

              <p style={{ marginTop: '8px', fontSize: '10px', color: 'rgba(255,255,255,0.6)' }}>
                ⚠️ <strong>IMPORTANT:</strong> Lights need TWO cables each:<br/>
                • <strong>DMX cable</strong> (carries control signal) - daisy-chain from interface through all lights<br/>
                • <strong>Power cable</strong> (120V/240V AC) - each light plugs into wall outlet separately
              </p>
            </div>
          </div>
        )}
