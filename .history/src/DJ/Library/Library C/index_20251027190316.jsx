...
const LibraryC = ({ id, onTrackLoad = () => {}, onTrackPreview = () => {}, onStyleChange = () => {}, tracks = [], isLoading = false, style = {}, ...props }) => {
  ...
  return (
    <div 
      className={`library-a-widget ${isDragging ? 'dragging' : ''}`}
      style={currentStyle} 
      onMouseDown={handleMouseDown}
      {...props}
    >
      <div className="library-a-header">
        <h3>Library A</h3>
        <span className="track-count">{availableTracks.length}</span>
      </div>
      
      <div className="library-a-content">
        {/* Search Bar */}
        ...
        <div className="track-list-header">
          ...
          <button 
            className={`sort-btn ${libraryState.sortBy === 'artist' ? 'active' : ''}`}
