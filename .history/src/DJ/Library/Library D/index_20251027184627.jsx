...
const LibraryD = ({ id, onTrackLoad = () => {}, onTrackPreview = () => {}, onStyleChange = () => {}, tracks = [], isLoading = false, style = {}, ...props }) => {
  ...
  return (
    <div 
      className={`library-b-widget ${isDragging ? 'dragging' : ''}`}
      style={currentStyle} 
      onMouseDown={handleMouseDown}
      {...props}
    >
      <div className="library-b-header">
        <h3>Library B</h3>
        <span className="track-count">{availableTracks.length}</span>
      </div>
      
      <div className="library-b-content">
        {/* Search Bar */}
