...
import './styles.css'; // Deck D - Green theme
...
const DeckD = ({ 
  ...
  return (
    <div 
      ref={elementRef}
      className={`deck-d-widget ${isDragging ? 'dragging' : ''} ${isResizing ? 'resizing' : ''}`}
      style={currentStyle}
      onMouseDown={handleMouseDown}
      {...props}
    >
      <div className="deck-d-header">
        <div className="deck-title">DECK D</div>
            ...
            <input
              ...
              onChange={async (e) => {
                ...
                if (track && newBpm && newBpm > 0 && newBpm <= 300) {
                  ...
                  audioManager.decks.D.track = { ...audioManager.decks.D.track, bpm: newBpm };
                  if (audioManager.onTrackLoaded) {
                    audioManager.onTrackLoaded('D', audioManager.decks.D.track);
                  }
                }
              }}
              disabled={!track}
            ...
            <select
              ...
              onChange={async (e) => {
                ...
                if (track && newKey) {
                  ...
                  audioManager.decks.D.track = { ...audioManager.decks.D.track, key: newKey };
                  if (audioManager.onTrackLoaded) {
                    audioManager.onTrackLoaded('D', audioManager.decks.D.track);
                  }
                }
