    ...
    >
      ...
      <div className="deck-a-content">
        ...
        <div className="track-info" style={{backgroundColor: 'rgba(0, 0, 0, 0.5)', padding: '8px', borderRadius: '8px', marginBottom: '8px', width: '100%', boxSizing: 'border-box'}}>
          <div className="track-title" style={{color: 'white', fontSize: '14px', fontWeight: 'bold', marginBottom: '8px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '100%'}}>
            {(() => {
          ...
          <div className="transport-controls" style={{marginBottom: '8px'}}>
            <button 
          ...
          {/* Progress Bar */}
          <div className="progress-container" style={{marginTop: '-5px', marginBottom: '-3px'}}>
            <div 
