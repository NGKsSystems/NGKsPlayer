  ...
  return (
    ...
    >
      ...
      <div className="deck-a-content">
        ...
        <div className="track-info" style={{backgroundColor: 'rgba(0, 0, 0, 0.5)', padding: '5px 8px 8px 8px', borderRadius: '8px', marginBottom: '8px', width: '100%', boxSizing: 'border-box'}}>
