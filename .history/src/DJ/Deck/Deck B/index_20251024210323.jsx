...
const DeckB = ({ 
  ...
  const handleMouseDown = useCallback((e) => {
    if (e.target.closest('.transport-controls') || e.target.closest('.quick-controls') || e.target.closest('.track-info') || e.target.closest('.fine-tune-controls') || e.target.closest('.fine-tune-slider-section')) {
      return;
    }
  ...
  return (
    ...
    >
      ...
      {/* FINE TUNE HEADER WITH BUTTONS INLINE */}
      <div className="fine-tune-controls">
        <div className="fine-tune-header-with-buttons">
          <div className="fine-tune-header-top">
      ...
      {/* FINE TUNE SLIDER - SEPARATE SECTION */}
      <div className="fine-tune-slider-section">
        <div 
