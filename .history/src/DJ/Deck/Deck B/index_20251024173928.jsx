...
const DeckB = ({ 
  ...
  return (
    ...
    >
      ...
      {/* FINE TUNE SECTION - Premium Control Panel */}
      ...
      {/* VU METER & WAVEFORM SECTION - Large, Professional Display */}
      <div className="vu-waveform-section">
        <div className="vu-waveform-header">VU & WAVEFORM B</div>
