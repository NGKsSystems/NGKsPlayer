...
const PlayerB = ({ 
  ...
  const [fineTune, setFineTune] = useState(0); // Fine-tuning pitch in cents (-50 to +50)
      ...
      <div className="player-b-content">
        ...
        <div className="fine-tune-section">
          <div className="fine-tune-header">
            ...
            <span className="fine-tune-value">{fineTune > 0 ? '+' : ''}{fineTune} ¢</span>
          </div>
          <input 
            type="range" 
            min="-50" 
            ...
            title="Fine-tune pitch adjustment in cents"
          />
        </div>
      </div>
