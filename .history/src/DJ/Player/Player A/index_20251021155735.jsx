  ...
  return (
    ...
    >
      ...
      <div className="player-a-content">
        {/* Track Info */}
        <div className="track-info" style={{backgroundColor: 'rgba(0, 0, 0, 0.5)', padding: '8px', borderRadius: '8px', marginBottom: '8px'}}>
          <div className="track-title" style={{color: 'white', fontSize: '16px', fontWeight: 'bold', marginBottom: '4px'}}>
            {(() => {
