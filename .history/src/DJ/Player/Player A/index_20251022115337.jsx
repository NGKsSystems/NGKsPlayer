...
const PlayerA = ({ 
  ...
  const [fineTune, setFineTune] = useState(0); // Fine position adjustment (±5 seconds)
    ...
    >
      ...
      <div className="player-a-content">
        ...
        <div className="hotkeys-section">
          <div className="hotkeys-label">CUE HOTKEYS</div>
          <div className="hotkeys-grid">
            <div className="hotkey-item">
              <span className="hotkey-key">Q</span>
              <span className="hotkey-label">Cue In</span>
            </div>
            <div className="hotkey-item">
              <span className="hotkey-key">W</span>
              <span className="hotkey-label">Cue Out</span>
            </div>
            <div className="hotkey-item">
              <span className="hotkey-key">E</span>
              <span className="hotkey-label">Loop</span>
            </div>
            <div className="hotkey-item">
              <span className="hotkey-key">R</span>
              <span className="hotkey-label">Sync</span>
            </div>
          </div>
        </div>
        ...
        <div className="fine-tune-section">
          <div className="fine-tune-header">
            <label className="fine-tune-label">CUE POSITION</label>
            <span className="fine-tune-value">{fineTune > 0 ? '+' : ''}{fineTune}s</span>
          </div>
          <input 
            type="range" 
            min="-50" 
            ...
            onChange={(e) => {
              ...
              setFineTune(offset);
              // Adjust playback position by the fine-tune offset
              const newPosition = Math.max(0, Math.min(duration, position + offset));
              onSeek(newPosition);
            }}
            className="fine-tune-slider"
            title="Fine position adjustment for cueing (±5 seconds per slider range)"
          />
        </div>
      </div>
