    ...
    >
      ...
      <div className="player-a-content">
        ...
        <div className="track-info">
          <div className="track-title" style={{color: 'white', fontSize: '16px'}}>
            {(() => {
              console.log('[Player A] Track data:', track);
              console.log('[Player A] AudioManager:', audioManager);
              
              // Try multiple sources for track title
              if (track?.title) {
                console.log('[Player A] Using track.title:', track.title);
                return track.title;
              }
              if (track?.fileName) {
                console.log('[Player A] Using track.fileName:', track.fileName);
              ...
              if (audioManager) {
                ...
                console.log('[Player A] AudioManager track:', audioManagerTrack);
                if (audioManagerTrack?.title) {
                  console.log('[Player A] Using audioManagerTrack.title:', audioManagerTrack.title);
                  return audioManagerTrack.title;
                }
                if (audioManagerTrack?.fileName) {
                  console.log('[Player A] Using audioManagerTrack.fileName:', audioManagerTrack.fileName);
                ...
                if (audioManagerTrack?.filePath) {
                  ...
                  console.log('[Player A] Using audioManagerTrack.filePath:', filename);
              ...
              if (audioManager) {
                ...
                if (audioElement && audioElement.src) {
                  ...
                  if (match) {
                    console.log('[Player A] Using audio src filename:', match[0]);
              ...
              if (track?.filePath) {
                ...
                console.log('[Player A] Using track.filePath:', filename);
                return filename ? filename.replace(/\.[^/.]+$/, "") : 'Unknown Track';
              }
              
              console.log('[Player A] No track title found, showing fallback');
