      ...
      <div style={{
        ...
        <div style={{
          ...
          {samples.map((sample, index) => (
            <div key={sample.id} style={{ display: 'flex', gap: '8px' }}>
              {/* Main Play Button */}
              <button
                style={{
                  ...
                  flex: 1,
                  textAlign: 'center',
                  boxShadow: playingId === sample.id ? '0 0 12px rgba(231, 76, 60, 0.5)' : '0 4px 8px rgba(0,0,0,0.3)'
                }}
                onClick={() => {
              ...
              <button
                style={{
                  ...
                  flex: 1,
                  textAlign: 'center',
                  boxShadow: playingId === `cue-${sample.id}` ? '0 0 12px rgba(231, 76, 60, 0.5)' : '0 4px 8px rgba(0,0,0,0.3)'
                }}
                onClick={() => {
