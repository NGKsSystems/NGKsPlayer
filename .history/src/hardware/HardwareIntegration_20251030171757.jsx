...
// Import commented out temporarily - EventEmitter needs browser-compatible version
...
const HardwareIntegration = ({ audioContext, onNavigate }) => {
  ...
  const updateDeviceList = () => {
    // Use Web MIDI API directly for now
  ...
  const renderDVSTab = () => (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-gray-800/50 rounded-lg p-6">
        <h3 className="text-xl font-bold text-white mb-4">Supported Hardware:</h3>
