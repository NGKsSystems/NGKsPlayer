...
export class LightingController {
  constructor(options = {}) {
    this.options = {
      protocol: options.protocol || 'DMX512', // DMX512, Art-Net, sACN
      interface: options.interface || 'USB',   // USB, Ethernet
      universe: options.universe || 1,
      refreshRate: options.refreshRate || 44, // Hz (standard DMX rate)
