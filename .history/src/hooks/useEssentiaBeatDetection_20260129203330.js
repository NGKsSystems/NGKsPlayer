  ...
  useEffect(() => {
    ...
    if (!essentiaRef.current) {
      const loadEssentia = async () => {
        try {
          // Import the WASM factory function and Essentia class
          ...
          console.log('[Essentia] WASM factory type:', typeof EssentiaWASM);
          
          // EssentiaWASM is an Emscripten module factory - call it to initialize WASM
          const wasmModule = await EssentiaWASM();
          
          if (!mounted) return;
          
          console.log('[Essentia] WASM initialized, has EssentiaJS:', typeof wasmModule?.EssentiaJS);
          
          // Create Essentia instance with initialized WASM module
