...
const DEFAULT_LAYOUT = {
  ...
  widgets: {
    ...
    crossfader: { xN: 0.25, yN: 0.65, wN: 0.5, hN: 0.18, z: 3 },
      ...
      if (saved) {
        ...
        if (parsed.version === 1 && parsed.widgets) {
          ...
          if (parsed.widgets.crossfader) {
            parsed.widgets.crossfader.wN = 0.5; // 50% width instead of 40%
            parsed.widgets.crossfader.xN = 0.25; // Reposition to center better
            parsed.widgets.crossfader.hN = 0.18; // Taller height
          }
