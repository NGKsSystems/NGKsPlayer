    ...
    if (!essentiaRef.current) {
      const loadEssentia = async () => {
        try {
          ...
          console.log('[Essentia] EssentiaWASM type:', typeof EssentiaWASM);
          console.log('[Essentia] Essentia type:', typeof Essentia);
          
          // Create Essentia instance directly with the WASM module
          // (0.1.3 does NOT use a factory pattern - pass module directly)
