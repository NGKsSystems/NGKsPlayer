  ...
  useEffect(() => {
    ...
    if (!essentiaRef.current) {
      const loadEssentia = async () => {
        try {
          // Use dynamic import to load Essentia modules
          const EssentiaModule = await import('essentia.js');
          
          if (!mounted) return;
          
          console.log('[Essentia] Module loaded:', Object.keys(EssentiaModule));
          console.log('[Essentia] EssentiaWASM type:', typeof EssentiaModule.EssentiaWASM);
          console.log('[Essentia] EssentiaWASM has EssentiaJS:', typeof EssentiaModule.EssentiaWASM?.EssentiaJS);
          
          // Create Essentia instance with WASM backend from package
