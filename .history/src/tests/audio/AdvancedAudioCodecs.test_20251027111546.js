...
describe('DSD Codec', () => {
  describe('Format Detection', () => {
    ...
    test('should detect DSF format', () => {
      ...
      'fmt '.split('').forEach((char, i) => view.setUint8(28 + i, char.charCodeAt(0)));
      view.setUint32(32, 52, true); // fmt size
      view.setUint32(36, 1, true); // Format version
      view.setUint32(40, 0, true); // Format ID
      view.setUint32(44, 2, true); // Channel type
      view.setUint32(48, 2, true); // Channel count
      view.setUint32(52, 2822400, true); // Sampling frequency
      view.setUint32(56, 1, true); // Bits per sample
      view.setBigUint64(60, BigInt(1000000), true); // Sample count
      view.setUint32(68, 4096, true); // Block size
