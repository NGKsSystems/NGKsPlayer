...
const Clipper = ({ onNavigate }) => {
  ...
  const handlePlayPause = () => {
    ...
    if (isPlaying) {
      ...
      const updateInterval = setInterval(() => {
        const newTime = currentTime + (audioContext.currentTime - startTime) * 1000;
  ...
  const handleCreateClip = (clipName) => {
  ...
  return (
    <div className="clipper-container">
      ...
      <div className="clipper-layout">
        {/* Left: File Loader */}
        <div className="clipper-panel loader-panel">
          <FileLoader onFileLoad={handleFileLoad} currentFile={audioFile} />
        </div>

        {/* Center: Waveform Editor */}
        <div className="clipper-panel editor-panel">
          {audioBuffer ? (
            <WaveformEditor
        ...
        {/* Right: Clips List & Export */}
        <div className="clipper-panel clips-panel">
          {audioBuffer && (
            <>
              <ClipsList
                clips={clips}
