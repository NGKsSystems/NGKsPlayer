  ...
  const handlePlayPause = () => {
    ...
    if (isPlayingRef.current) {
      ...
      requestAnimationFrame(() => {
        ...
        // Track playback position - USE REAL TIME instead of AudioContext time
        let logCounter = 0;
        const realStartTime = performance.now();
        const interval = setInterval(() => {
          const realElapsedTime = performance.now() - realStartTime;
          const newTime = startingTimeMs + realElapsedTime;
          ...
          // setCurrentTime(newTime); // DISABLED FOR TESTING
          console.log('Would set time to:', newTime / 1000, 'seconds');
        }
