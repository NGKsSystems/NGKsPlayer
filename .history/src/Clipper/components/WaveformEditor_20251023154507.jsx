...
const WaveformEditor = ({
  ...
  useEffect(() => {
    ...
    // Redraw ONLY the playhead area - first erase the old one
    // We'll redraw a vertical strip to clear the old playhead
    const maxPlayheadWidth = 5;
    const lastPlayX = canvasWidth; // Approximate - not perfect but prevents trails
