...
const Clipper = ({ onNavigate }) => {
  ...
  const handlePlayPause = () => {
    ...
    if (isPlayingRef.current) {
      ...
      const realStartTime = Date.now(); // Real world time when we started
      ...
      const interval = setInterval(() => {
        ...
        const realElapsedTime = Date.now() - realStartTime;
        ...
        if (logCounter % 10 === 0) {
          console.log('Time comparison:', { 
            audioContextElapsed: elapsedTime,
            realWorldElapsed: realElapsedTime,
            ratio: elapsedTime / realElapsedTime,
