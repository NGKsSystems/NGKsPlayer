...
function executeClipMove({ clipId, fromTrackId, toTrackId, newPosition }, trackManager) {
  console.log('🔧 executeClipMove:', { clipId, fromTrackId, toTrackId, newPosition });
  ...
  console.log('📍 Found clip:', clipData.clip.name, 'in track:', clipData.track.id);
  ...
  console.log('✨ Moving clip with updated position:', updatedClip);
  
  const result = trackManager.moveClipToTrack(clipId, fromTrackId, toTrackId, updatedClip);
  console.log('📤 moveClipToTrack result:', result);
