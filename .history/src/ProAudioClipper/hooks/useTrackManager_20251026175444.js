    ...
    setTracks(prev => prev.map(track => ({
      ...
      clips: track.clips.flatMap(clip => {
        ...
        console.log('Split clip:', {
          ...
          splitTime,
          firstClipDuration,
          firstClip: { id: firstClip.id, startTime: clip.startTime, endTime: firstClip.endTime, duration: firstClip.duration, audioOffset: firstClip.audioOffset },
        ...
        console.log('Returning split clips:', [firstClip, secondClip]);
