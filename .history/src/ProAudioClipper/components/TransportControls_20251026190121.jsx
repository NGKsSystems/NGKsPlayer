      ...
      <div className="shortcuts-info">
        <div className="shortcuts-columns-container" style={{ 
          ...
          <div className="shortcuts-column" style={{ 
            ...
            <span className="shortcut" style={{ fontSize: '10px', color: '#888', opacity: '0.8' }}>✂️ <strong>Editing:</strong> X: Cut | C: Copy | V: Paste | Delete: Remove</span>
            <span className="shortcut" style={{ fontSize: '10px', color: '#888', opacity: '0.8' }}>🔧 <strong>Tools:</strong> R: Razor Tool | Q: Selection Tool</span>
            ...
            <span className="shortcut" style={{ fontSize: '10px', color: '#888', opacity: '0.8' }}>📥 <strong>Import:</strong> Click "Add Track" Button | Drag Files</span>
          ...
          <div className="shortcuts-column" style={{ 
            ...
            <span className="shortcut" style={{ fontSize: '10px', color: '#888', opacity: '0.8' }}>🚀 <strong>Advanced:</strong> Ctrl+A: Select All | Esc: Deselect</span>
            <span className="shortcut" style={{ fontSize: '10px', color: '#888', opacity: '0.8' }}>🎨 <strong>Selection:</strong> Ctrl+Click: Multi-Select</span>
            <span className="shortcut" style={{ fontSize: '10px', color: '#888', opacity: '0.8' }}>🏆 <strong>Pro Tip:</strong> Use right-click for more options!</span>
          </div>
        </div>
      </div>
    </div>
