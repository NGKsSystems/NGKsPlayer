 ...
 * 
 * Full-featured timeline with proper track headers and waveform visualization
 */
const ProfessionalTimeline = React.forwardRef(({
  ...
  const TRACK_HEIGHT = 60; // Even more compact track height
  const HEADER_WIDTH = 150; // Much smaller header width - just enough for essential controls
                ...
                >
                  ...
                  {track.clips && track.clips.map(clip => (
                    ...
                    >
                      ...
                      {/* Clip Name - Positioned at top left corner, smaller */}
                      <div style={{
                        position: 'absolute',
                        left: '4px',
                        top: '4px',
