      ...
      <div className="shortcuts-info">
        <div className="shortcuts-columns-container" style={{ 
          ...
          <div className="shortcuts-column" style={{ 
            ...
            <span className="shortcut" style={{ fontSize: '10px', color: '#888', opacity: '0.8' }}>✂️ <strong>Editing:</strong> R: Razor Tool | X: Cut | C: Copy | V: Paste</span>
          ...
          <div className="shortcuts-column" style={{ 
            ...
            <span className="shortcut" style={{ fontSize: '10px', color: '#888', opacity: '0.8' }}>🚀 <strong>Selection:</strong> Ctrl+Click: Multi-Select | Double-Click: Zoom</span>
            ...
            <span className="shortcut" style={{ fontSize: '10px', color: '#888', opacity: '0.8' }}>🏆 <strong>Pro Tip:</strong> Each track has independent speed/reverse!</span>
          </div>
        </div>
      </div>
    </div>
