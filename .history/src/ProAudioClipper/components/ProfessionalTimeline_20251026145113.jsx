...
const ProfessionalTimeline = React.forwardRef(({
  ...
  const handleClipMouseDown = useCallback((e, clip) => {
    console.log('🔥 CLIP MOUSE DOWN:', clip.name);
    e.stopPropagation();
    ...
    console.log('🚀 Setting isDraggingClip to true');
  ...
  const handleMouseUp = useCallback((e) => {
    console.log('🖱️ MOUSE UP - isDraggingClip:', isDraggingClip, 'draggedClip:', !!draggedClip);
  ...
  useEffect(() => {
    if (isDraggingClip) {
      ...
      return () => {
        console.log('🗑️ Removing mouse event listeners');
