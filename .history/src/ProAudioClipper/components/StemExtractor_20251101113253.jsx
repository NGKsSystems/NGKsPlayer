    ...
    return (
      <div className="stem-extractor-modal">
        <div className="python-error">
          ...
          <p>Stem separation requires Python 3.8+ with Spleeter installed.</p>
          
          <div className="install-instructions">
            <h4>Installation Steps:</h4>
            <ol>
              <li>Install Python 3.8+ from <a href="https://python.org" target="_blank" rel="noopener noreferrer">python.org</a></li>
              <li>Open terminal/command prompt</li>
              <li>Run: <code>pip install -r python/requirements.txt</code></li>
            </ol>
          </div>
