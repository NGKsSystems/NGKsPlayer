...
const TimelineRuler = ({ 
  ...
  const pixelToTime = useCallback((pixelX) => {
    ...
    const timeAtPixel = viewportStart + (relativeX / (pixelsPerSecond * zoom));Pro Production Suite
    ...
    Ambience
    
    Timeline: 14.23s / 230.51s
    Tracks: 6
    Quality: full
    Engine: GPU
    Video Mode
    Caption Editor (for "Closed Captioning" purposes only 😉)
