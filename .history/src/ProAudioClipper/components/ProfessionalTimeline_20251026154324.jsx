    ...
    if (dragPreview && dragPreview.snapTime !== undefined && dragPreview.targetTrackId) {
      ...
      if (snapTime !== undefined && targetTrackId) {
        ...
        if (originalTrack && originalTrack.id !== targetTrackId) {
          ...
          console.log('🔄 CLIP MOVE: Different track -', draggedClip.name, 'from', originalTrack.id, 'to', targetTrackId);
          if (onClipMove) {
          ...
          console.log('🔄 CLIP MOVE: Same track -', draggedClip.name, 'from', draggedClip.startTime, 'to', snapTime);
          if (onClipMove) {
