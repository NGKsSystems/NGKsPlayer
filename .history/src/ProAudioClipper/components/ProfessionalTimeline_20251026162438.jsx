...
const ProfessionalTimeline = React.forwardRef(({
  ...
  const handleClipMouseDown = useCallback((e, clip) => {
    console.log('🖱️ Mouse down on clip:', clip.name);
    e.preventDefault();
    e.stopPropagation();
    ...
    console.log('🚀 Starting drag for:', clip.name);
  ...
  const handleMouseUp = useCallback((e) => {
    console.log('🖱️ Mouse up - isDragging:', isDraggingClip, 'draggedClip:', draggedClip?.name);
