...
const ProfessionalTimeline = React.forwardRef(({
  ...
  const handleMouseUp = useCallback((e) => {
    console.log('🖱️ Mouse up - checking for clip move:', { isDraggingClip, draggedClip: !!draggedClip, dragPreview: !!dragPreview });
    
    if (isDraggingClip && draggedClip && dragPreview) {
      const { snapTime, targetTrackId } = dragPreview;
      
      console.log('📍 Drag data:', { snapTime, targetTrackId, originalStartTime: draggedClip.startTime });
      ...
      if (snapTime !== undefined && targetTrackId) {
        ...
        console.log('🎬 Creating updated clip:', updatedClip);
        ...
        console.log('🎯 Found original track:', originalTrack?.id);
        
        if (originalTrack && originalTrack.id !== targetTrackId) {
          // Moving to different track
          console.log('➡️ Moving to different track');
          if (onClipMove) {
          ...
          console.log('↔️ Same track, different position');
          if (onClipMove) {
                ...
                tracks.map((track, trackIndex) => (
                  <div 
                    ...
                    style={{
                      ...
                      ...(isDraggingClip && dragPreview?.targetTrackId === track.id && {
