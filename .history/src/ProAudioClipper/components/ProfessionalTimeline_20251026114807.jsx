...
const ProfessionalTimeline = React.forwardRef(({
  ...
  const handleContextMenuAction = useCallback((action) => {
    ...
    closeContextMenu();
  }, [contextMenuClip, contextMenuTrack, onClipDelete, onTrackDelete, onTrackNameChange, onTrackMute, onTrackSolo, onTrackMoveUp, onTrackMoveDown, onTrackSelect, tracks, closeContextMenu]);
