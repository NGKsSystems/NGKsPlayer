                      ...
                      >
                        ...
                        {clip.audioBuffer && (
                          <div style={{
                            ...
                            top: '0',
                            width: `${clipWidthPixels - (2 * marginPixels)}px`,
                            height: '100%'
                          }}>
                            <SimpleWaveform
                              audioBuffer={clip.audioBuffer}
                              width={clipWidthPixels - (2 * marginPixels)}
                              height={TRACK_HEIGHT - 4}
                              color="rgba(255,255,255,0.3)"
                              backgroundColor="transparent"
                              audioOffset={clip.audioOffset || 0}
                              clipDuration={visualDuration}
                            />
                          </div>
                        )}
