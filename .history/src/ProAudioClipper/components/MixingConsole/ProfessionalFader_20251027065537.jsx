    ...
    >
      ...
      <div className="fader-track">
        ...
        <div className="fader-scale">
          <div className="scale-mark unity" style={{[orientation === 'vertical' ? 'bottom' : 'left']: `${((0 - min) / (max - min)) * 100}%`}}>
            <span>0</span>
          </div>
          <div className="scale-mark" style={{[orientation === 'vertical' ? 'bottom' : 'left']: `${((-12 - min) / (max - min)) * 100}%`}}>
            <span>-12</span>
          </div>
          <div className="scale-mark" style={{[orientation === 'vertical' ? 'bottom' : 'left']: `${((-24 - min) / (max - min)) * 100}%`}}>
            <span>-24</span>
          </div>
          <div className="scale-mark max" style={{[orientation === 'vertical' ? 'bottom' : 'left']: '100%'}}>
            <span>+12</span>
          </div>
          <div className="scale-mark min" style={{[orientation === 'vertical' ? 'bottom' : 'left']: '0%'}}>
            <span>-∞</span>
          </div>
        </div>
      ...
      <div 
        ...
        ref={knobRef}
        style={{
          [orientation === 'vertical' ? 'bottom' : 'left']: `calc(${position}% - 8px)`
        }}
      >
