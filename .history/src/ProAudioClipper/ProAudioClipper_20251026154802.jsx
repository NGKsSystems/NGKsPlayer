...
const ProAudioClipper = ({ onNavigate }) => {
  ...
  useEffect(() => {
    ...
    console.log('🔧 Audio Engine: Updating playback parameters with', trackManager.tracks.length, 'tracks');
  ...
  const handleClipMove = useCallback((clipId, fromTrackId, toTrackId, updatedClip) => {
    console.log('🎯 CALLBACK: handleClipMove called for clip', clipId, 'from', fromTrackId, 'to', toTrackId);
