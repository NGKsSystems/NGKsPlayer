      ...
      <div className="header-bar">
        ...
        <div className="header-actions">
          ...
          <button
            ...
            className={`header-btn ${showMarkerPanel ? 'active' : ''}`}
      ...
      <div className="main-layout">
        ...
        <div className="center-panel">
          ...
          <NavigationControls
            ...
            onJumpToPrevious={handleJumpToPrevious}
            playbackRate={playbackRate}
            onPlaybackRateChange={setPlaybackRate}
          />
          ...
          <ProfessionalTimeline
            ...
            onSelectLoopRegion={setSelectedLoopId}
            onAddLoopRegion={addLoopRegion}
            onResizeLoopRegion={resizeLoopRegion}
