    ...
    >
      ...
      {showVisualDisplay && (
        <VisualDisplay
          ...
          djName="" // User can set this
          eventName="" // User can set this
          currentTime={currentTime}
          duration={duration}
          displayMode="fullscreen"
          visualMode="album-art" // 'album-art', 'waveform', 'spectrum', 'minimal', 'dj-mode'
          layout="center" // 'center', 'bottom-bar', 'corner', 'side-panel'
