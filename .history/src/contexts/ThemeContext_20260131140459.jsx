...
export const ThemeProvider = ({ children }) => {
  ...
  const changeTheme = async (themeId) => {
    // 1. Aggressive cleanup FIRST - kill old effects completely
    ...
    // 3. Small delay to force reflow and prevent bleeding
    setTimeout(() => {
      // Apply color variables
      ...
      // 4. Load Chromatic Chaos effects (or other themes)
      if (themeId === 'chromaticChaos') {
        import('../themes/chromatichaos/index.js')
          .then(themeModule => {
