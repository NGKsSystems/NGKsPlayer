...
export const ThemeProvider = ({ children }) => {
  ...
  useEffect(() => {
    const loadTheme = async () => {
      try {
        // Load theme.json from the folder
        const module = await import(`../themes/${currentTheme}/theme.json`);
        const loadedTheme = module.default || module;
        ...
        console.log('🎨 Loaded from folder:', currentTheme);
