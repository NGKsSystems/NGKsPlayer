...
console.log('🚀 NowPlayingSimple.jsx loaded!')

export default function NowPlayingBasic({ onNavigate }) {
  console.log('🎵 NowPlayingSimple component rendering')
  ...
  useEffect(() => {
    ...
    console.log('🚨🚨🚨 COMPONENT MOUNTED - LOGGING WORKS! 🚨🚨🚨')
  }, [beatPulseEnabled])

  // Test log on mount
  useEffect(() => {
    console.log('🎵 NowPlayingSimple LOADED - Threshold:', beatThresholdRef.current, 'Min:', beatMinRef.current, 'Gate:', beatGateRef.current)
    console.error('🚨 ERROR LOG TEST - If you see this, console works!')
    setTimeout(() => {
      console.warn('⚠️ WARNING LOG TEST - 1 second after mount')
    }, 1000)
  }, [])
  ...
  const drawWaveform = () => {
    ...
    const draw = () => {
      ...
      if (beatDetectionRef.current.debugCounter % 60 === 0) {
        console.log('🎵 Beat Check:', {
      ...
      if (beatPulseEnabledRef.current && bassSpike && aboveMin && timeSinceLastBeat > gate) {
