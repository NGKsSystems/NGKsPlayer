  ...
  const renameFile = async (track) => {
    ...
    try {
      ...
      if (result && result.success) {
        ...
        console.log('[Frontend] File renamed, forcing library refresh...')
        
        // Force complete refresh by incrementing trigger and reloading
        setRefreshTrigger(prev => prev + 1)
        setTimeout(async () => {
          await loadTracks()
          console.log('[Frontend] Library reloaded after rename')
        }, 100)
