...
export default function NowPlayingBasic({ onNavigate }) {
  ...
  const drawWaveform = () => {
    ...
    const draw = () => {
      ...
      // SPIKE DETECTION: Only trigger on SUDDEN increases, not sustained audio
      const bassSpike = bassAverage > avgBass * 1.4  // 40% spike above recent average
      const absoluteMinimum = bassAverage > 100      // Still needs some bass energy
      ...
      if (beatPulseEnabledRef.current && bassSpike && absoluteMinimum && timeSinceLastBeat > 250) {
