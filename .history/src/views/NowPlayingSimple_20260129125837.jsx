          ...
          if (typeof Meyda !== 'undefined') {
            meydaAnalyzerRef.current = Meyda.createMeydaAnalyzer({
              ...
              callback: (features) => {
                ...
                const fluxThreshold = Math.max(avgFlux * 1.5, 0.001)  // Much lower threshold (was 2.5)
                
                const now = Date.now()
                const timeSinceLastBeat = now - beatDetectionRef.current.lastBeat
                
                // More aggressive triggering for rock/hard music
                const isOnset = (flux > fluxThreshold || rms > 0.05) && timeSinceLastBeat > 100  // Reduced from 150ms
