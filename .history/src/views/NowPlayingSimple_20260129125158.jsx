    ...
    const draw = () => {
      ...
      if (waveformType === 'line') {
        ...
        for (let i = 0; i < bufferLength; i++) {
          ...
          const y = (v * height) / 2 * 1.8  // Boosted amplitude (was 1.0)
        ...
        for (let i = 0; i < bufferLength; i++) {
          const barHeight = (frequencyData[i] / 255) * height * 1.5  // Boosted from 0.8 to 1.5
        ...
        const pulseScale = beatPulse ? 1.3 : 1  // Stronger pulse (was 1.1)

        for (let i = 0; i < bufferLength; i++) {
          const angle = (i / bufferLength) * Math.PI * 2
          const amplitude = (dataArray[i] / 128.0 - 1) * radius * 0.9 * pulseScale  // Boosted from 0.5 to 0.9
