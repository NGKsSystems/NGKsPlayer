...
export default function NowPlayingBasic({ onNavigate }) {
  ...
  const [useEssentiaBeats, setUseEssentiaBeats] = useState(true)
  ...
  // Essentia hook - DISABLED TO PREVENT WASM DOWNLOAD DIALOG
  // const { isReady: essentiaReady } = useEssentiaBeatDetection({
  const essentiaReady = false; // Temporarily disabled
  /*
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          {/* Top: Waveform and Controls - Reduced height */}
