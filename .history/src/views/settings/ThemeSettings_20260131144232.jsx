  ...
  return (
    <div className="p-6 space-y-6" style={{ 
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" key={currentTheme}> {/* Force re-render on theme change */}
          {Object.values(themes).map((theme) => (
            <button
              key={`${theme.id}-${currentTheme}`} {/* Force button re-render */}
