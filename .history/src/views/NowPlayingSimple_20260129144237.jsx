  ...
  return (
    <>
      ...
      <div className="p-4 bg-gray-800 border-b border-gray-700 flex items-center justify-center relative overflow-hidden" style={{ height: '200px' }}>
        ...
        {/* Beat Detection Control Panel */}
        {showBeatControls && (
          <div className="absolute top-20 left-4 z-30 bg-gray-800 border border-gray-600 rounded-lg p-4 w-80 shadow-xl max-h-96 overflow-y-auto">
            <h3 className="text-sm font-bold mb-3 text-gray-200">Beat Detection Controls</h3>
