...
export default function Library() {
  ...
  const playPlaylist = useCallback(async (playlistId) => {
    ...
    try {
      ...
      // Send playlist context to Now Playing player
      window.api.sendToPlayer({ type: 'playlist', playlistId });
      ...
      >
        {loading ? null : (
          <>
            ...
            {tab === "Playlists" && (filter.playlist ? renderSongs(songs) : renderPlaylists())}
