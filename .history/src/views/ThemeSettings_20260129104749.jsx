...
const ThemeSettings = () => {
  ...
  return (
    <div className="p-6 space-y-6" style={{ 
      ...
      <div>
        <h2 className="text-2xl font-bold mb-4 glow-text" style={{ color: 'var(--accent-primary)' }}>
          Theme Settings
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {Object.values(themes).map((theme) => (
            <button
              ...
              style={{
                backgroundColor: currentTheme === theme.id ? 'var(--button-active)' : 'var(--button-bg)',
                borderColor: currentTheme === theme.id ? 'var(--accent-primary)' : 'var(--border-subtle)',
                color: currentTheme === theme.id ? 'var(--bg-primary)' : 'var(--text-primary)'
              }}
            >
