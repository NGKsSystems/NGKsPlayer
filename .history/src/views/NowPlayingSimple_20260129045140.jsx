  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900 text-white" onClick={() => setContextMenu(null)}>
      ...
      <div className="flex-1 p-6 bg-gray-800 border-b border-gray-700 flex items-center justify-center relative overflow-hidden">
        ...
        {/* Track Info Overlay */}
        <div className="relative z-10 text-center" style={{ textShadow: '0 2px 8px rgba(0,0,0,0.8)', maxWidth: '90%', margin: '0 auto' }}>
          {currentTrack ? (
              ...
              {nextTrackInfo && (
                <div className="mt-8 pt-6 border-t border-gray-600">
                  ...
                  <p 
                    ...
                    style={{
                      fontFamily: '"Arial Black", "Impact", sans-serif',
                      fontSize: 'clamp(1.5rem, 3.5vw + 0.5rem, 2.5rem)',
                      WebkitTextStroke: '4px rgba(255, 255, 255, 0.3)',
                      paintOrder: 'stroke fill',
                  ...
                  {nextTrackInfo.album && (
                    <p 
                      ...
                      style={{
                        fontSize: 'clamp(0.75rem, 1.75vw + 0.25rem, 1.25rem)',
                        color: '#0ea5e9',
