...
const DraggableWidget = ({ 
  ...
  */
  ...
  const handlePointerDown = useCallback((e) => {
    ...
    // Allow interaction with slider, knob, and other interactive elements
    ...
    if (!isVolumeWidget && e.target.closest('.mixer-sub-widget') && !e.target.closest('.widget-header') && !isInteractiveElement) {
      return;
    }
