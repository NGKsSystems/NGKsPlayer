      ...
      <div className="obs-integration-panel" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="obs-content">
          ...
          <div className="obs-section obs-instructions">
            <h3>Quick Setup Guide for {streamingSoftware.find(s => s.id === selectedSoftware)?.name}</h3>
            
            {/* OBS Studio Instructions */}
            {selectedSoftware === 'obs' && (
              <ol>
                <li>
                  <strong>Open Broadcast Window:</strong> Click the button above to open a window for capture
                </li>
                <li>
            ...
            {selectedSoftware === 'streamlabs' && (
              <ol>
                <li>
                  <strong>Open Broadcast Window:</strong> Click the button above
                </li>
                <li>
          ...
          <div className="obs-section obs-tips">
            <h3>💡 Pro Tips</h3>
            <ul>
              <li><strong>Camera Setup:</strong> Layer the "Bar" or "Minimal" theme over your DJ camera feed for professional broadcasts</li>
              <li><strong>Multi-Cam:</strong> Use multiple cameras (overhead for decks, face cam) and switch between them</li>
              <li><strong>Scene Composition:</strong> Create different scenes - "DJ Cam + Overlay", "Full Track Info", "Camera Only"</li>
              <li><strong>Resolution:</strong> 1080p works best for most streaming platforms (YouTube, Twitch, Facebook)</li>
              <li><strong>Monitor Setup:</strong> Put broadcast window on second monitor so you can see what viewers see</li>
              <li><strong>Green Screen:</strong> Use "Minimal" theme with green screen behind you for custom backgrounds</li>
              <li><strong>Auto-Updates:</strong> Window updates in real-time as you mix - no manual updates needed!</li>
              <li><strong>Lighting:</strong> Good lighting on your face is more important than expensive cameras!</li>
            </ul>
          </div>
        </div>
      </div>
