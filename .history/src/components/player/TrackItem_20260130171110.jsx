  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Left Side: File Name, Album, Genre in single row */}
        <div className="flex-1 flex items-center gap-4 min-w-0">
          {/* File Name */}
          <div className="font-medium text-white truncate min-w-0 flex-shrink-0" style={{ maxWidth: '200px' }}>
            {track.title || 'Unknown Title'}
          </div>
          
          {/* Album */}
          {track.album && (
            <div className="text-sm text-gray-300 truncate min-w-0 flex-shrink-0" style={{ maxWidth: '150px' }}>
              Album: {track.album}
            </div>
          )}
          ...
          {/* Genre */}
          {track.genre && (
            <div className="text-sm text-gray-400 truncate min-w-0 flex-shrink-0" style={{ maxWidth: '100px' }}>
              {track.genre}
            </div>
          )}
        </div>
