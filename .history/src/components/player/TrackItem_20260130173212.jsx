    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 flex items-center min-w-0">
          ...
          <div 
            className="font-medium text-white overflow-hidden relative group" 
            style={{ width: '350px', minWidth: '350px' }}
          >
            <div 
              className="truncate transition-transform duration-1000 ease-in-out group-hover:animate-none"
              style={{
              ...
              onMouseEnter={(e) => {
                ...
                const scrollDistance = element.scrollWidth - container.clientWidth;
                if (scrollDistance > 0) {
