    ...
    <div className="p-4 bg-gray-800 border-b border-gray-700">
      ...
      <div className="flex items-center justify-between gap-4 mb-3">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={onPrevTrack}
            className="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded text-base font-semibold"
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            className={`px-3 py-2 rounded text-lg ${playMode === 'stop' ? 'bg-blue-600' : 'bg-gray-600 hover:bg-gray-500'}`}
          ...
          <button
            className={`px-3 py-2 rounded text-lg ${playMode === 'inOrder' ? 'bg-blue-600' : 'bg-gray-600 hover:bg-gray-500'}`}
          ...
          <button
            className={`px-3 py-2 rounded text-lg ${playMode === 'repeatAll' ? 'bg-blue-600' : 'bg-gray-600 hover:bg-gray-500'}`}
          ...
          <button
            className={`px-3 py-2 rounded text-lg ${playMode === 'randomNoRepeat' ? 'bg-blue-600' : 'bg-gray-600 hover:bg-gray-500'}`}
