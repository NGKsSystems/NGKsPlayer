...
const DraggableWidget = ({ 
  ...
  useEffect(() => {
    ...
    const handleMouseUp = () => {
      if (isDragging) {
        if (controlled) {
          // In controlled mode, notify parent instead of saving to localStorage
          if (onDragEnd) {
      ...
      if (isResizing) {
        if (controlled) {
          ...
          // Uncontrolled mode: save to localStorage and handle mirroring
          try {
  ...
  // Only active in uncontrolled mode
  useEffect(() => {
