...
const LibraryWidget = ({
  ...
  const [libraryControls, setLibraryControls] = useState(() => {
    ...
    // Default layout - positioned for deck A/B
    ...
    <div className={`library-widget library-${deck.toLowerCase()}`}>
      <div className="library-workspace">
        ...
        <DraggableWidget
          ...
          initialPosition={{ x: deck === 'A' ? 10 : 400, y: 10 }}
        ...
        <DraggableWidget
          ...
          initialPosition={{ x: deck === 'A' ? 300 : 690, y: 10 }}
        ...
        <DraggableWidget
          ...
          initialPosition={{ x: deck === 'A' ? 10 : 400, y: 340 }}
        ...
        <DraggableWidget
          ...
          initialPosition={{ x: deck === 'A' ? 370 : 760, y: 340 }}
