...
<body>
  <div class="container">
    ...
    <div id="tipModal" style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.8); z-index: 1000; padding: 20px;">
      <div style="background: #1a1a2e; border-radius: 15px; padding: 20px; max-width: 500px; margin: 50px auto;">
        ...
        <div style="margin-top: 15px; display: flex; gap: 10px;">
          <button onclick="sendTip()" style="flex: 1; padding: 10px; background: #27ae60; border: none; border-radius: 8px; color: white; font-weight: 600; cursor: pointer;">Send Tip</button>
        ...
        <p style="margin-top: 15px; font-size: 12px; color: rgba(255,255,255,0.5); text-align: center;">Tips are recorded for the DJ. Payment processing not yet implemented.</p>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function sendTip() {
      ...
      closeTipModal();
      alert(\`Tip of $\${amount} recorded! (Payment processing coming soon)\`);
    }
  </script>
</body>
</html>`;
