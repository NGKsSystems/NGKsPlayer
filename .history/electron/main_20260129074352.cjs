...
function register(channel, handler) {
  console.log(`[REGISTER] Attempting to register: ${channel}`);
  try { ipcMain.removeHandler(channel); } catch {}
  ipcMain.handle(channel, handler);
  console.log(`[REGISTER] Successfully registered: ${channel}`);
}
...
console.log('[HANDLER REGISTRATION] Registering library:renameFile...');
